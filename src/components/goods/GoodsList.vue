<template>
    <div class="tmpl">
        ...
        <van-pull-refresh v-model="refreshing" @refresh="onRefresh" pulling-text="下拉即可刷新..." loosing-text="释放即可刷新..." loading-text="加载中...">
            <van-list v-model="loading" :finished="finished" @load="onLoad" loading-text="加载中..." :offset="offset">
                <div class="list">
                    <ul class="mui-table-view mui-grid-view mui-grid-9">
                        <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3" v-for="(item,index) in list" :key="index" @click="toDetail(item.cover[0])">
